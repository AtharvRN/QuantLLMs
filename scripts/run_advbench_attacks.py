...
Supports two lightweight attacks:
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--attack", choices=["shallow", "uja"], default="shallow")
    p.add_argument("--attempts", type=int, default=6, help="Max attempts for UJA")
